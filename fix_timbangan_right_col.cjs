...
const rightColEnd = `{/* Footer showing table entries controls to match the mockup */}`;

const parts = code.split(rightColStart);
const innerParts = parts[1].split(rightColEnd);

// innerParts[1] still contains the closing divs of the right col, and the fallback text. Let's be careful.
...
const replacement = `
        <div className="lg:col-span-8 flex flex-col min-h-[500px]">
          {activeBalItem ? (
            ...
            <div className="bg-white border border-slate-200 p-12 text-center text-slate-400 rounded-sm flex flex-col items-center justify-center flex-1 h-full">
...
// Wait, I need to make sure I replace from rightColStart to the end of the file or the end of the div.
// Let's check what comes after rightColStart.
