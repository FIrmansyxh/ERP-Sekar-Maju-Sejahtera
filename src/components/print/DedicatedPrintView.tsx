  ...
  return (
    <div className="print-modal-backdrop fixed inset-0 z-[9999] flex flex-col bg-[#f8f9fa] font-sans text-gray-900 select-none">
      ...
      <main className="flex-1 overflow-y-auto p-4 sm:p-6 bg-gray-100 flex justify-center items-start print:p-0 print:m-0 print:bg-white print:overflow-visible">
        <div
          ref={printAreaRef}
          className="print-canvas-paper bg-white border border-gray-300 print:border-none shadow-md print:shadow-none p-5 sm:p-8 mx-auto w-full max-w-[980px] print:max-w-none text-slate-900 font-sans print:m-0 transition-transform duration-100"
          style={{ 
            minHeight: '1050px',
