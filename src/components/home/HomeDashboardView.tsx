...
export const HomeDashboardView: React.FC<HomeDashboardViewProps> = ({
  ...
  const allMenus = [
    ...
    { no: 4, nama: 'Laporan Stok & Mutu Grade', judul: 'Rekapitulasi Mutu Grade, Tonase Bal, Valuasi Inventaris & Perputaran Stok', modId: 'modul-6-laporan-grade' },
    { no: 5, nama: 'Laporan Pembelian Barang', judul: 'Rekapitulasi Pembelian Multi-Parameter, Potongan Kuli & Tikar', modId: 'modul-6-laporan-pembelian' },
    { no: 6, nama: 'Laporan Okupansi & Stok Gudang', judul: 'Monitoring Kapasitas, Okupansi Bal & Inventaris Tembakau Per Gudang', modId: 'modul-6-laporan-gudang' },
    ...
    { no: 10, nama: 'Master Kualitas & Harga Beli', judul: 'Tarif Acuan Grade A-F & Ketentuan Kualitas Tembakau Masuk', modId: 'modul-3-harga' },
    ...
    { no: 12, nama: 'Master Data Gudang', judul: 'Lokasi Simpan, Blok & Kapasitas Pergudangan', modId: 'modul-7-gudang' },
    { no: 13, nama: 'Inventaris Bal Gudang', judul: 'Stok Fisik Bal & Lokasi Simpan', modId: 'modul-2-barang' },
    { no: 14, nama: 'Sortir', judul: 'Proses 1: Kupon Petani, Sortir Mutu Grade Bal & Penentuan No Bal', modId: 'modul-0-sortir' },
    { no: 15, nama: 'Timbangan', judul: 'Proses 2: Standby Scan No Bal, Input Berat Bruto/Netto & Lokasi Gudang', modId: 'modul-0-timbangan' },
    { no: 16, nama: 'Kasir', judul: 'Proses 3: Data Pembelian Barang, Rekap Pembayaran & Cetak Nota Resmi', modId: 'modul-0-kasir' },
