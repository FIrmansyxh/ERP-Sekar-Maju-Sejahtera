...
export const HomeDashboardView: React.FC<HomeDashboardViewProps> = ({
  ...
  const allMenus = [
    ...
    { no: 3, nama: 'Laporan Stok & Mutu Grade', judul: 'Rekapitulasi Mutu Grade, Tonase Bal, Valuasi Inventaris & Perputaran Stok', modId: 'modul-6-laporan-grade' },
    { no: 4, nama: 'Laporan Pembelian Barang', judul: 'Rekapitulasi Pembelian Multi-Parameter, Potongan Kuli & Tikar', modId: 'modul-6-laporan-pembelian' },
    { no: 5, nama: 'Laporan Okupansi & Stok Gudang', judul: 'Monitoring Kapasitas, Okupansi Bal & Inventaris Tembakau Per Gudang', modId: 'modul-6-laporan-gudang' },
    { no: 6, nama: 'Laporan Petani & Setoran', judul: 'Rekapitulasi Kinerja Penyetoran, Volume Bal & Nilai Pembelian Per Petani', modId: 'modul-6-laporan-petani' },
    { no: 7, nama: 'Laporan Pengiriman & DO Pabrik', judul: 'Distribusi Bal Tembakau, Surat Jalan Pabrik Rekanan & Armada Logistik', modId: 'modul-6-laporan-pengiriman' },
    { no: 8, nama: 'Master Petani', judul: 'Data Petani Tembakau & Kartu Scan Setoran', modId: 'modul-1-petani' },
    { no: 9, nama: 'Master Kualitas & Harga', judul: 'Tarif Acuan Grade A-F & Ketentuan Kualitas', modId: 'modul-3-harga' },
    { no: 10, nama: 'Master Data Gudang', judul: 'Lokasi Simpan, Blok & Kapasitas Pergudangan', modId: 'modul-7-gudang' },
    { no: 11, nama: 'Inventaris Bal Gudang', judul: 'Stok Fisik Bal & Lokasi Simpan', modId: 'modul-2-barang' },
    ...
    { no: 16, nama: 'Pengiriman Sample', judul: 'Uji Laboratorium Mutu & Approval Grade Sample', modId: 'modul-4-sample' },
    { no: 17, nama: 'Manajemen Pengguna (RBAC)', judul: 'Otorisasi Staf & Hak Akses Role Kerja', modId: 'modul-users' },
  ];
