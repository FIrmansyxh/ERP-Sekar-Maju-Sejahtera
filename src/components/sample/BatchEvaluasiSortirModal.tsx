        ...
        >
          ...
          <div className="bg-gray-50 border-b border-gray-200 p-4 space-y-3 shrink-0">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5">
              ...
              <div className="bg-blue-50 border border-blue-200 p-2.5 rounded-sm shadow-xs">
                <div className="text-[10px] text-blue-700 font-bold flex items-center space-x-1">
                  <Clock className="w-3 h-3" />
                  <span>Menunggu Evaluasi</span>
                </div>
                <div className="text-base font-bold text-blue-800">{countMenunggu} Bal</div>
                <div className="text-[10px] text-blue-700">Dalam proses lab</div>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-5 overflow-y-auto space-y-3.5 flex-1 bg-gray-100/70">
                  ...
                  >
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-gray-200/80 pb-3">
                      <div className="flex items-start space-x-3">
                        <div className="flex flex-col items-center justify-center w-12 h-12 bg-gray-900 text-white font-mono rounded-xs shrink-0">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            ...
                            {item.sudah_dikirim_do && (
                              <span className="px-1.5 py-0.2 text-[10px] font-bold text-blue-700 bg-blue-100 border border-blue-200 rounded-xs flex items-center space-x-0.5">
                    ...
                    <div className="pt-3 grid grid-cols-1 md:grid-cols-12 gap-3 items-start">
                      ...
                      <div className="md:col-span-7 space-y-2">
                        ...
                        {isPending && (
                          <div className="bg-blue-50/70 border border-blue-200 p-2.5 rounded-xs text-[11px] text-blue-900 flex items-center space-x-2">
            ...
            <div className="bg-white p-4 border border-gray-300 rounded-sm space-y-3 mt-4">
              <h4 className="text-xs font-bold text-gray-900 border-b border-gray-200 pb-1.5">
                Keterangan Hasil Sortir Batch & Petugas Evaluator
              </h4>
          ...
          <div className="px-5 py-3.5 border-t border-gray-200 bg-white flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                type="button"
                onClick={() => setIsConfirmOpen(true)}
                className="px-4 py-2 text-xs font-bold text-white bg-slate-800 hover:bg-slate-900 rounded-sm transition flex items-center space-x-1.5 cursor-pointer shadow-xs"
              >
                <Save className="w-3.5 h-3.5" />
