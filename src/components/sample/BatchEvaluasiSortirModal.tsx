...
export const BatchEvaluasiSortirModal: React.FC<BatchEvaluasiSortirModalProps> = ({
  ...
  return (
    <>
      <div 
        className="fixed inset-0 z-50 bg-[#b81d24]/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-5 overflow-y-auto font-sans animate-in fade-in duration-150"
        onClick={(e) => {
